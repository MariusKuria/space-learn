        ...
        <div class="row feature-content-wrap">
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <h3 class="info__title">Tavo Instruktoriai</h3>
                    <p class="info__text">"Sveiki, vaikai! Mes esame čia, kad su jumis dalintumėmės žiniomis apie kosmosą, žvaigždes, kosminius erdvėlaivius ir kitas įdomybes!</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <h3 class="info__title">Skirskime į žvaigždes</h3>
                    <p class="info__text">Mes tau atskleisime daug kosmoso pasaulio paslapčių, nuo žvaigždžių pavadinimų iki to, kaip veikia astronautų drabužiai!</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box">
                    ...
                    <h3 class="info__title">Smagios pamokos</h3>
                    <p class="info__text">Tavęs laukia daug smagių eksperimentų ir žaidimų, kuriuose galėsi sužinoti daug įdomybių apie kosmoso pasaulį.</p>
                </div><!-- end info-box -->
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
    </div><!-- end container -->

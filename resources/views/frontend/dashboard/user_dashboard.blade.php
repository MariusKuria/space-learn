...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/css/line-awesome.cs') }}s">
...
<section class="dashboard-area">
    <div class="off-canvas-menu dashboard-off-canvas-menu off--canvas-menu custom-scrollbar-styled pt-20px">
        ...
        @include('frontend.dashboard.body.sidebar')  <!--SITAS MANO IDETAS-->
    ...
    <div class="dashboard-content-wrap">
        ...
        <div class="container-fluid">
            ...
            @yield('userdashboard') <!--MANO KEISTAS -->
           
           
            @include('frontend.dashboard.body.footer')  <!--SITAS MANO IDETAS-->

...
<div class="page-content">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Slaptažodžio keitimas</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Slaptažodžio keitimas</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                    ...
                    <div class="card">
                        ...
                        <form method="POST" action="{{ route('instructor.password.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Senas Slaptažodis</h6>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Naujas Slaptažodis</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Patvirtinti Naują Slaptažodį</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="submit" class="btn btn-primary px-4" value="Išsaugoti pakitimus" />
                                    </div>
                                </div>
                            </div>
